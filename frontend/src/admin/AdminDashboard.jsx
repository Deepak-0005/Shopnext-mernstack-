...
const AdminDashboard = () => {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '1000px', margin: '0 auto' }}>
      ...
      <div style={{ marginTop: '30px', padding: '24px', background: '#111827', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.05)' }}>
        <h3 style={{ color: '#f97316', marginBottom: '12px' }}>Quick Links</h3>
        <ul style={{ color: '#e5e7eb', lineHeight: '1.8', paddingLeft: '20px' }}>
          <li><a href="/admin/add-product" style={{ color: '#f59e0b' }}>Add Product</a></li>
          <li><a href="/admin/products" style={{ color: '#f59e0b' }}>Manage Products</a></li>
          <li><a href="/admin/orders" style={{ color: '#f59e0b' }}>Manage Orders</a></li>
          <li><a href="/admin/users" style={{ color: '#f59e0b' }}>Users Directory</a></li>
        </ul>
      </div>
    </div>
  );
