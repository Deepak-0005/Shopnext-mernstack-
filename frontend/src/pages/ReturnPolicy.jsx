...
const ReturnPolicy = () => {
    return (
        <div style={textualStyle}>
            ...
            <p style={{ marginBottom: '20px' }}>
                Items must be returned in the same absolute condition that it was received, and maintained within its original factory packaging. Receipts or proof of purchase mappings are strictly required.
            </p>
